<?php
	include("../config.php");
	$sql = "SELECT * FROM tbl_supplier ORDER BY id desc";
	...
	while($rs = mysqli_fetch_array($res)){
		...
		if($rs['id'] == 67)
		{
			$option1 = '<div class="hidden-sm hidden-xs action-buttons unselectable">
										<a id="view" title="View" class="blue" href="#" data-val="'.$rs['id'].'"> <i class="ace-icon fa fa-search-plus bigger-130"></i> </a> 
										<a id="edit_disable" title="Edit" class="green" href="#" data-val="'.$rs['id'].'"> <i class="ace-icon fa fa-pencil bigger-130"></i> </a> 
										<a id="disable_disable" title="Disable" class="orange" href="#" data-val="'.$rs['id'].'" > <i class="ace-icon fa fa-lock bigger-130"></i> </a> 
									</div>
									';
		}
