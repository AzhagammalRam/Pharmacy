      ...
      <div class="main-content-inner">
        <div class="page-content">
          <div class="page-header">
            <h1> Master Entry <small> <i class="ace-icon fa fa-angle-double-right"></i> Manage Currency </small> </h1>
          </div>
          <div class="row">
            <div class="col-xs-12">
              <div class="row">
                <div class="col-xs-12">
                  <div class="table-header"> List of Currencies 
				  <a data-toggle="modal" data-target="#modal-new-currency" class="pull-right" style="margin-right:15px;color:#FFFFFF;text-decoration:none;cursor:pointer;"><i class="ace-icon fa fa-user"></i>  Add New Currency </a>				  </div>
                  <div>
			  ...
			  <div id="modal-update" class="modal fade" tabindex="-1">
                <div class="modal-dialog">
			      ...
			      <div id="modal-new-currency" class="modal fade" tabindex="-1">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header no-padding">
                      ...
                      <div class="modal-body no-padding">
                        ...
                        <form id="newcurrency" >
                              ...
                              <tr>
                                <th scope="row" style="vertical-align:middle;">Name *</th>
                                <td colspan="3"><input type="text" required id="currency" name="currency" placeholder="Currency Name"></td>
                              </tr>
                              <tr>
                                <th scope="row" style="vertical-align:middle;">Base Currency</th>
                                <td colspan="3"><select name="base_currency" id="base_currency">
                                <option value='1'>Yes</option>
                                <option value='0'>No</option>  
                              </select></td>
                              </tr>
...
<script src="manage-currency/manage-currency.js"></script>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		$('#table-user-list').dataTable( {
			bAutoWidth: false,
			"bProcessing": true,
			"sAjaxSource": "manage-currency/return-currency-list.php",
			"aoColumns": [
				{ mData: '#',"bSortable": true },
				{ mData: 'currency' },
        { mData: 'base_currency',"sClass": "tdcenter" },
