			  ...
			  <div id="modal-new-doctor" class="modal fade" tabindex="-1">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body no-padding">
                      <div class="col-xs-12">
					  	<form id="newdoctor" enctype="multipart/form-data">
                        <table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
                          <tr>
                            <th scope="row" style="vertical-align:middle;">Name *</th>
                            <td colspan="3"><input type="text" required id="doctor" name="doctor" placeholder="Doctor Name"></td>
                          </tr>
                          <tr>
                            <th rowspan="4" scope="row" style="vertical-align:middle;">Address</th></tr>
                          ...
                          <tr>
                          <th scope="row" style="vertical-align:middle;">Document Type</th>
                          <td colspan="3"><input type="text" id="doctype" name="doctype" placeholder="Document Type">
                          </tr>
                          <tr>
                          <th scope="row" style="vertical-align:middle;">Input File</th>
                          <td colspan="3"><input type="file" name="image" id="newPhoto"></td>
                          </tr>
						 <!-- <tr>
                            <th scope="row" style="vertical-align:middle;">TIN #</th>
