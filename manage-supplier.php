                    ...
                    <div class="modal-body no-padding">
                      <div class="col-xs-12">
                        <table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
						  ...
						  <tr>
                            <th scope="row" style="vertical-align:middle;display:none;">TIN #</th>
                            <td style ="display:none;" id="vtin"></td>
							
                          </tr>
                          <tr>
                            <th scope="row" style="vertical-align:middle;">TAX NUMBER</th>
                            <td id="vcst"></td>
                            <th scope="row" style="vertical-align:middle;">GST Number</th>
                            <td id="vgstnumber"></td>
                           </tr>
						  <tr>
					...
					<div class="modal-body no-padding">
                      <div class="col-xs-12">
                        ...
                        <table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
						  ...
						  <tr>
                            <th scope="row" style="vertical-align:middle;">Contact #</th>
                            <td><input type="text" id="ucontact1" name="ucontact1" maxlength="14" placeholder="Contact # 1"></td>
							<th scope="row" style="vertical-align:middle;">Contact #</th>
                            <td><input type="text" id="ucontact2" name="ucontact2" maxlength="14" placeholder="Contact # 2"></td>
                          </tr>
						  <tr>
                            <th scope="row" style="vertical-align:middle;">Email</th>
						  ...
						  <tr>
                            <th scope="row" style="vertical-align:middle; display:none;">TIN #</th>
                            <td style ="display:none;"><input type="text" id="utin" name="utin" placeholder="TIN #"></td>
							
                          </tr>
                          <tr>
                            <th scope="row" style="vertical-align:middle;">TAX NUMBER</th>
                            <td><input type="text" id="ucst" name="ucst" placeholder="TAX NUMBER"></td>
                            <th scope="row" style="vertical-align:middle;">GST Number</th>
                            <td><input type="text" id="ugstnumber" name="ugstnumber" placeholder="GST Number"></td>
                           </tr>
                    ...
                    <div class="modal-body no-padding">
                      <div class="col-xs-12">
                        ...
                        <table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
						  ...
						  <tr>
                            <th scope="row" style="vertical-align:middle;">Contact #</th>
                            <td><input type="text" id="contact1" name="contact1" maxlength="14" placeholder="Contact # 1"></td>
							<th scope="row" style="vertical-align:middle;">Contact #</th>
                            <td><input type="text" id="contact2" name="contact2" maxlength="14" placeholder="Contact # 2"></td>
                          </tr>
						  <tr>
                            <th scope="row" style="vertical-align:middle;">Email</th>
						  ...
						  <tr>
                            <th scope="row" style="vertical-align:middle;display:none;">TIN #</th>
                            <td style ="display:none;"><input type="text" id="tin" name="tin" placeholder="TIN #"></td>
							
                          </tr>
                          <tr>
                            <th scope="row" style="vertical-align:middle;">TAX NUMBER</th>
                            <td><input type="text" id="cst" name="cst" placeholder="TAX NUMBER"></td>
                            <th scope="row" style="vertical-align:middle;">GST Number</th>
                            <td><input type="text" id="gstnumber" name="gstnumber" placeholder="GST Number"></td>
                           </tr>
                        </table>
						</form>
						<br />
