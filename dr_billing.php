...
<div class="main-content-inner">
  <div class="page-content">
    <div class="page-header">
      <h1> Drug Return <small> <i class="ace-icon fa fa-angle-double-right"></i> Billing </small> <a style="display:none" class="btn btn-sm btn-success pull-right" data-toggle="modal" data-target="#mdlNewBill" style="text-align:none;"> New Bill</a> </h1>
    </div>
    <!-- /.page-header -->
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="center"> <br />
          <div class="widget-box">
            ...
            <div class="widget-body">
              ...
              ///$res = mysqli_query($db,"SELECT * FROM tbl_billing WHERE status = 2");
              
              $res = mysqli_query($db,"SELECT * FROM tbl_drug_return_billing where status = '2'");
              while($rs = mysqli_fetch_array($res)){ ?>
                    ...
                    <div class="modal fade direct-bill" tabindex="-1" role="dialog" id="modal-view<?php echo $rs['id']; ?>" data-keyboard="false" data-backdrop="static">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          <div class="modal-header no-padding">
                            <div class="table-header">Drug Return : <?php echo $rs['patientname']; ?></div>
                          </div>
                ...
                Commented available
                 <label class="col-xs-2 control-label">Aval</label>
                                  ...
                                  <div class="col-xs-2">
                                  <input type="text" class="form-control input-sm mand number" name="qty<?php echo $rs['id']; ?>" id="qty<?php echo $rs['id']; ?>" placeholder="0" onBlur="validate_Qty('<?php echo $rs['id']; ?>')">
                                  </div>
                                  <input type="button" class="btn btn-sm btn-info col-xs-1" value="Add" onClick="addBilling_Items('<?php echo $rs['id']; ?>')" />
                                </div>
                          ...
                          <div class="modal-footer no-margin-top">
                            ...
                            <label class="pull-left col-xs-2">Payment: </label>
              ...
              <!-- <div class="pull-left col-xs-2">
                            Commented out as discount is not required.
...
<script src="manage-bill/dr_manage-bill.js"></script>
