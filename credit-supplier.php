    ...
    <div class="main-content-inner">
      <div class="page-content">
        <div class="page-header">
            <h1> Credit Pay <small> <i class="ace-icon fa fa-angle-double-right"></i> Supplier Credit </small> </h1>
          </div>
        <!-- /.page-header -->
        <div class="row">
          <div class="col-xs-12">
           ...
           <label for="name" class="col-xs-3 control-label" >Supplier Name</label>
            <div class="col-xs-3" style="margin-top:6px">
          <input type="text" class="form-control" name="supplier" id="supplier" value="" placeholder="Supplier Name" list="lstSupplier">
...
//	if(d1 != "" &&  supplier != "" &&  invoiceno != "")
//	{
//		alert('please Fill any fields ')
//	return;
//	}
	$.ajax({
		type: 'post',
		url: 'manage-credit/return-credit-supplier.php',
		data: {
			fromdate: d1,
			fromto: d2,
			supplier: supplier,
	...
	if (parseInt(remamt) <= parseInt(baamount))
	 {
		 ...
		 $.ajax({
		type: 'post',
		url: 'manage-credit/payremain.php',
		data: {
			id: id,
			amount: remamt,
		},
