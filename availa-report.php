...
<thead>
  <tr>
	...
	<th style="text-align: center;">Adjust Reson</th>
	<th style="text-align: center;">Adjust Type</th>
  </tr>
</thead>
<tbody>
</tbody>
	...
	$.ajax({
		...
		success: function(msg) {
			...
			for(var i = 0; i < x.length - 1; i++){
				var tr = "<tr><td>"+x[i].date+"</td><td>"+x[i].productname+"</td><td>"+x[i].billno+"</td><td>"+x[i].batchno+"</td><td>"+x[i].qty+"</td><td>"+x[i].expiry+"</td><td class='tax1'>"+x[i].adjreason+"</td><td class='tax1'>"+x[i].adjtype+"</td></tr>";
				 $(table).append(tr);
			}
