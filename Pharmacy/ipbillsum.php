...
<meta charset="utf-8" />
<title>Ip Bill Summary Report</title>
    ...
    <div class="main-content-inner">
      <div class="page-content">
        <div class="page-header">
            <h1> Report <small> <i class="ace-icon fa fa-angle-double-right"></i> Ip Bill Summary Report </small> </h1>
          </div>
        <!-- /.page-header -->
        <div class="row">
          <div class="col-xs-12">
             ...
             <form class="form-horizontal">
                <div class="row">
                  <div class="form-group">
                    ...
                    <label for="paymentmode" class="col-xs-1 control-label"> Patient Id</label>
                
                    <div class="col-xs-2">
                      <input type="text" class="form-control" id="ipno" name="ipno"  placeholder="Enter Patiend Id">
                    </div>
                    
                   <label for="paymentmode" class="col-xs-2 control-label"> Payment Type</label>
                    ...
                    <label for="name" class="col-xs-1 control-label">Admission Date</label>
                    <div class="col-xs-2">
                      <input type="text" class="form-control" name="dtfrom" id="dtfrom" placeholder="DD/MM/YYYY">
                    </div>
                    
                     <label for="name" class="col-xs-2 control-label"> Discharge To</label>
                    <div class="col-xs-2">
...
<thead>
  <tr>
    ...
    <th style="text-align: center;">IP No </th>
...
<div><input type="submit" value="Print" onClick="printipsum()"></div>
...
function rptDisplay(){
   ...
   if(ipno == ""){
	...
	$.ajax({
		type: 'post',
		url: 'manage-report/return-ip-sum.php',
		data: {
			fromdate: d1,
			fromto: d2,
			paymentmode: pm,
