          ...
          <div class="col-xs-12">
			...
			<?php
				...
				while($r = mysqli_fetch_array($res1)){
					...
					echo "<tr><td>".$r['productid']."</td><td>".$rs['productname']."</td><td>".$r['qty']."</td><td>".$r['batchno']."</td><td>".$r['expirydate']."</td><td>".$r['pprice']."</td><td>".$r['mrp']."</td><td>".$r['tax_percentage']."</td><td>".$r['tax_amount']."</td><td><img src='images/delete.png' style='width: 24px; cursor: pointer;' onClick='javascript:deleteItem(this,".$r['id'].")' /></td></tr>";
				}
			?>
            </tbody>
          </table>
