...
function addBillingItems(x){
	...
	$.ajax({
		...
		success: function(msg) {
			var t = JSON.parse(msg);
		var tr = "<tr><td>"+t.code+"</td><td>"+t.type+"</td><td>"+t.desc+"</td><td>"+t.qty+"</td><td>"+t.sup_nm+"</td><td>"+t.batch+"</td><td>"+t.expi+"</td><td>"+t.tax_percentage+"</td><td>"+t.amt+"</td><td><img src='images/delete.png' style='height:24px; cursor:pointer;' onClick='javascript:deleteItem(this,"+t.id+")'></td></tr>";
