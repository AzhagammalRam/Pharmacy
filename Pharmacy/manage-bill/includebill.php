  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="mdlNewQuickBillIp">
    <div class="modal-dialog modal-xs">
      ...
      <input type="text"  class="form-control input-sm mand invoicedate" tabindex="120" value="<?php echo date("d-m-Y");?>" disabled placeholder="YYYY/MM/DD" name="billdates" id="billdates">
        ...
        <div class="form-group">
              <label class="col-xs-3 control-label">IP Patient ID/Ph no</label>
              <div class="col-xs-8">
                <input type="text" class="form-control input-sm mand" tabindex="121" name="inv_pat_id" id="inv_pat_id" placeholder="IP Patient ID / Ph no" onBlur="getdetails($(this),2)">
              </div>
            </div>
