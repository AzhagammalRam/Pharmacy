...
<meta charset="utf-8" />
<title>Drug Return Report</title>
...
<div id="navbar" class="navbar navbar-default    navbar-collapse       h-navbar">
 ...
 <?php 
 $currenttab = 'Reports';
 $currentPage = 'Drug_Return_Report';
    ...
    <div class="main-content-inner">
      <div class="page-content">
        <div class="page-header">
            <h1> Report <small> <i class="ace-icon fa fa-angle-double-right"></i> Drug Return Report </small> </h1>
          </div>
        <!-- /.page-header -->
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="center"> <br />
             ...
             <form class="form-horizontal">
              ...
              <br />
             <table id="tbl-drugreturn-rpt" class="table table-fixed">
<thead>
  <tr>
...
function rptPrintXLS(){
	...
	var data = "fromdate="+d1+"&fromto="+d2;
	window.open("manage-report/excel-drug-return-report.php?"+data)
}
function rptDisplay(){
	var d1 = $('#dtfrom').val(), d2 = $('#dtto').val();

	var table = $("#tbl-drugreturn-rpt > tbody");
	if(d1 == "")
		return false;
	$.ajax({
		type: 'post',
		url: 'manage-report/return-drugreturn-report.php',
		data: {
			fromdate: d1,
			fromto: d2,
