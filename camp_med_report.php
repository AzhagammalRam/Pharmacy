...
<meta charset="utf-8" />
<title>Camp  Medicine Report</title>
    ...
    <div class="main-content-inner">
      <div class="page-content">
        <div class="page-header">
            <h1> Report <small> <i class="ace-icon fa fa-angle-double-right"></i> Camp Medicine Report </small> </h1>
          </div>
        <!-- /.page-header -->
        <div class="row">
          <div class="col-xs-12">
...
function rptDisplay(){
  ...
  if($.trim($('#dtto').val())== ""){ $('#dtto').css("border","2px dotted red"); return false; }
	...
	$.ajax({
		type: 'post',
		url: 'manage-report/return_camp_report.php',
		data: {
			fromdate: d1,
			fromto: d2,
			// paymentmode: pm,
