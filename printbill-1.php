...
$pdf->MultiCell(8.6, 0.25, "Zaara Pharmacy" , '0', "C");
$pdf->SetFont('Times','B',16);
$pdf->MultiCell(8.6, 0.25, "(Unit of Zaara Clinic)" , '0', "C");
...
$pdf->MultiCell(8.6, 0.2, "E-mail : zaaratechzone@gmail.com" , '0', "C");
$pdf->MultiCell(8.6, 0.2, "Website : www.zaaratechnologies.com" , '0', "C");
...
$cmd = mysqli_query($db,"SELECT datentime, patientname, drname, billno, paidamt,phno FROM tbl_billing WHERE billno = '$billno' and del_status != 1");
...
$pdf->Ln();
$pdf->Cell(1.8, 0.25, "Patient Ph No.    : ".$rs['phno'], '0','0', "L");
